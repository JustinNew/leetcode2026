...
# Key is to use a hash map to store the key and value.
# And use a doubly linked list to store the order of the keys.
...
# allOne.inc("hello"); // The key "hello" is now associated with count 1.
# allOne.inc("hello"); // The key "hello" is now associated with count 2.
# allOne.getMaxKey(); // return "hello"

# o(N) solution is easy
class AllOne:
    def __init__(self):
        self.myDict = {}
...
# o(1) solution with doubly linked list
# This is almost impossible to implement in a real interview, 
# but it is a good exercise to understand the doubly linked list.
class ListNode:
